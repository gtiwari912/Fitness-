...
public class cali_adv16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b16i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,cali_adv_intro.class);
        ...
        b16ii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,hspu.class);
                startActivity(intent);
            }
        });
        ...
        b16iii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,hspu90.class);
                startActivity(intent);
            }
        });
        ...
        b16iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,oah.class);
                startActivity(intent);
            }
        });
        ...
        b16v.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,imp_dip.class);
                startActivity(intent);
            }
        });
        ...
        b16vi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,shoulder_flag.class);
                startActivity(intent);
            }
        });
        ...
        b16vii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,human_flag.class);
                startActivity(intent);
            }
        });
        ...
        b16viii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,back_lever.class);
                startActivity(intent);
            }
        });
        ...
        b16ix.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,front_lever.class);
                startActivity(intent);
            }
        });
        ...
        b16x.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,vsit.class);
                startActivity(intent);
            }
        });
        ...
        b16xi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,manna.class);
                startActivity(intent);
            }
        });
        ...
        b16xii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,oac.class);
                startActivity(intent);
            }
        });
        ...
        b16xiii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,oap.class);
                startActivity(intent);
            }
        });
        ...
        b16xiv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,hefesto.class);
                startActivity(intent);
            }
        });
        ...
        b16xv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,entrada_de_angel.class);
                startActivity(intent);
            }
        });
        ...
        b16xvi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,planche.class);
                startActivity(intent);
            }
        });
        ...
        b16xvii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,maltese.class);
                startActivity(intent);
            }
        });
        ...
        b16xviii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,iron_cross.class);
                startActivity(intent);
            }
        });
        ...
        b16xix.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,inverted_cross.class);
                startActivity(intent);
            }
        });
        ...
        b16xx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_adv16.this,victorian_cross.class);
                startActivity(intent);
            }
        });
