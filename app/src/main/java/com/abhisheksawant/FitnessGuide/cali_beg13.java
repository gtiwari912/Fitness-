...
public class cali_beg13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b13vi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(cali_beg13.this,cali_beg13_vi.class);
        ...
        b13i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_beg13.this,cali_beg_intro.class);
                startActivity(intent);
            }
        });
        ...
        b13ii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_beg13.this,pushup.class);
                startActivity(intent);
            }
        });
        ...
        b13iii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_beg13.this,dips.class);
                startActivity(intent);
            }
        });
        ...
        b13iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_beg13.this,pullups.class);
                startActivity(intent);
            }
        });
        ...
        b13v.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cali_beg13.this,lyingcore.class);
                startActivity(intent);
            }
        });
